...
class Recommended_RecyclerView(private val recetteList: ArrayList<RecettesInQueue.Recette>):RecyclerView.Adapter<Recommended_RecyclerView.RecommendedViewHolder>() {
