...
class RecommendedFoodAdapter(private val blogList: ArrayList<Recette>):RecyclerView.Adapter<RecommendedFoodAdapter.RecommendedFoodViewHolder>() {
    ...
    inner class RecommendedFoodViewHolder(itemView: View ,listener: OnItemClickListener):RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecommendedFoodViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.blog_item, parent, false)
        return RecommendedFoodViewHolder(view,mListener)
    }

    override fun onBindViewHolder(holder: RecommendedFoodViewHolder, position: Int) {
